...
async def cmd_start(message: types.Message):
    try:
        ...
        await message.answer(
            "Правила бота для выкупа духов 100% кеш:\n"
            "‼️ Забронировали аромат - в этот же день заказали\n"
            "‼️ За всю эту раздачу можно выкупить не более 12 ароматов\n"
            "‼️1 аккаунт WB - 1 аромат в день 👍 (можно использовать максимум 3 аккаунта WB)\n\n"
        )
    except Exception as e:
